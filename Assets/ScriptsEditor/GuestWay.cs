...
public class GuestWay : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (gameObject.name == "nGardenGuest1") // Guest1 serve 1
        {
            currentTime = 5;
        }
        else if (gameObject.name == "nGardenGuest2") // Guest2 serve 2
        {
            currentTime = 35;
        }
        else if (gameObject.name == "nGardenGuest3") // Guest2 serve 2
        {
            currentTime = 60;
        }
        else if (gameObject.name == "Thief1") // Thief1 serve 4
        {
            currentTime = 15;
        }

        //player = GameObject.Find("counter1aL Variant (2)").GetComponent<Transform>();
    }
